...
name: hot-topics
description: >
  获取微博、知乎、百度、抖音、今日头条、B站等主流中文平台的实时热搜榜单和热门话题。
  USE when users want trending topics, hot searches, 热搜, or when zero-toutiao-entertainment
  needs fresh hot lists. Repo CLI: scripts/fetch_platform.py (60s.viki.moe).
license: MIT
metadata:
  author: vikiboss
  version: "1.0"
